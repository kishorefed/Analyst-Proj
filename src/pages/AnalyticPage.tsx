                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="relative flex-1 h-8 overflow-hidden rounded-lg bg-slate-100">
                                        <div
                                            className="flex h-full w-[70%] items-center justify-end rounded-lg bg-linear-to-r from-blue-500 to-blue-400 pr-3 text-[12px] font-bold text-white transition-[width] duration-1000"
                                        >
                                            45
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="relative flex-1 h-8 overflow-hidden rounded-lg bg-slate-100">
                                        <div
                                            className="flex h-full w-[50%] items-center justify-end rounded-lg bg-linear-to-r from-teal-500 to-teal-300 pr-3 text-[12px] font-bold text-white transition-[width] duration-1000"
                                        >
                                            32
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="relative flex-1 h-8 overflow-hidden rounded-lg bg-slate-100">
                                        <div
                                            className="flex h-full w-[48%] items-center justify-end rounded-lg bg-linear-to-r from-violet-500 to-violet-400 pr-3 text-[12px] font-bold text-white transition-[width] duration-1000"
                                        >
                                            28
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="relative flex-1 h-8 overflow-hidden rounded-lg bg-slate-100">
                                        <div
                                            className="flex h-full w-[34%] items-center justify-end rounded-lg bg-linear-to-r from-emerald-500 to-emerald-400 pr-3 text-[12px] font-bold text-white transition-[width] duration-1000"
                                        >
                                            22
                                        </div>
                                    </div>
                        ...
                        <div className="rounded-2xl border border-teal-900/10 bg-white p-7 shadow-md">
                            ...
                            <div className="relative flex h-50 items-end gap-6 border-b border-slate-200 pb-5">
                                <div className="flex flex-1 flex-col items-center gap-3">
                                    <div className="relative w-full rounded-t-lg bg-linear-to-b from-teal-500 to-teal-300" style={{ height: '60%' }}>
                                        <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[12px] font-bold text-teal-700">
                                            72%
                                        </div>
                                    </div>
                                    <div className="text-[11px] font-semibold text-slate-500">Week 1</div>
                                </div>
                                <div className="flex flex-1 flex-col items-center gap-3">
                                    <div className="relative w-full rounded-t-lg bg-linear-to-b from-teal-500 to-teal-300" style={{ height: '75%' }}>
                                        <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[12px] font-bold text-teal-700">
                                            78%
                                        </div>
                                    </div>
                                    <div className="text-[11px] font-semibold text-slate-500">Week 2</div>
                                </div>
                                <div className="flex flex-1 flex-col items-center gap-3">
                                    <div className="relative w-full rounded-t-lg bg-linear-to-b from-teal-500 to-teal-300" style={{ height: '85%' }}>
                                        <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[12px] font-bold text-teal-700">
                                            82%
                                        </div>
                                    </div>
                                    <div className="text-[11px] font-semibold text-slate-500">Week 3</div>
                                </div>
                                <div className="flex flex-1 flex-col items-center gap-3">
                                    <div className="relative w-full rounded-t-lg bg-linear-to-b from-teal-500 to-teal-300" style={{ height: '95%' }}>
                                        <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[12px] font-bold text-teal-700">
                                            87%
                                        </div>
                                    </div>
                                    <div className="text-[11px] font-semibold text-slate-500">Week 4</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-3 gap-5">
                        <div className="rounded-2xl border border-indigo-200 bg-linear-to-br from-white to-indigo-50 p-6 shadow-md">
                            ...
                            <div className="text-[13px] font-medium leading-relaxed text-indigo-900">
                                Your project has strong functional requirements. Consider adding performance metrics (response time, concurrent users) for completeness.
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl border border-indigo-200 bg-linear-to-br from-white to-indigo-50 p-6 shadow-md">
                            ...
                            <div className="text-[13px] font-medium leading-relaxed text-indigo-900">
                                Based on current pace, you'll complete requirement gathering 3 days ahead of schedule. Confidence trending upward at 5% per week.
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl border border-indigo-200 bg-linear-to-br from-white to-indigo-50 p-6 shadow-md">
                            ...
                            <div className="text-[13px] font-medium leading-relaxed text-indigo-900">
                                8 requirements have confidence below 70%. Prioritize clarification for "user-friendly" and "fast response" to avoid rework.
                            </div>
                        </div>
                    </div>
            </div>
