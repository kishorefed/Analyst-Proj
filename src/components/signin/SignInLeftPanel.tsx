...
export const SignInLeftPanel: React.FC = () => (
  <div className="flex flex-col overflow-hidden">
    ...
    <div className="flex flex-1 flex-col justify-center">
      <div>
        <div className="mb-5 p-4 inline-flex items-center gap-2 rounded-full border border-teal-200/20 bg-teal-400/10 px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-teal-200">
        ...
        <p className="mb-9 max-w-88.75 text-[14.5px] leading-relaxed text-white/46">
          Set up your client session in 3 quick steps. Our AI Business Analyst handles everything — from first question to final BRD — in 3 hours, not 4 weeks.
        </p>
      </div>
      ...
      <div className="mb-8 grid grid-cols-4 gap-2.5">
        {[
          ...
          { val: '96%', lbl: 'cost reduction per project' },
        ].map((stat, i) => (
          <div
            key={i}
